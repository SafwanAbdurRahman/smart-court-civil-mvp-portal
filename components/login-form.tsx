    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-lg font-semibold text-foreground">Sign in to SmartCourt</h1>
          <p className="mt-1 text-sm text-muted-foreground">AI-powered civil case document processing</p>
        </div>
